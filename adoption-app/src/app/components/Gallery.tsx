...
//
//             imgs.forEach((img) => {
//                 if (img.getBoundingClientRect().top < vh) {
//                     img.classList.remove('invisible');
//                     img.classList.add('animate-rise');
//                 }
//             });
//         };
//
...
//                     width={400}
//                     height={300}
//                     className="gallery-img w-full rounded-lg invisible transition-opacity duration-300 ease-in-out hover:opacity-90"
//                 />
//             ))}
//         </section>
//     );
